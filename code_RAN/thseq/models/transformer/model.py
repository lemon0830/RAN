...
class Transformer(_Model):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument('--encoder-post-norm', type=int, default=1)
        parser.add_argument('--decoder-post-norm', type=int, default=1)
        ...
        parser.add_argument('--enc-att-type', type=str,
                            choices=['std', 'rand', 'attwithrand', 'recrand', 'attwithrecrand', 'facrand'],
                            default='std')
        parser.add_argument('--dec-att-type', type=str,
                            choices=['std', 'rand', 'attwithrand', 'recrand', 'attwithrecrand', 'facrand'],
                            default='std')
        parser.add_argument('--cross-att-type', type=str,
                            choices=['std', 'rand', 'attwithrand', 'recrand', 'attwithrecrand', 'facrand'],
                            default='std')
        parser.add_argument('--dif', type=int, default=0)
        parser.add_argument('--rec-func', type=int, default=0)
